...
const Footer = () => {
  ...
  return (
    <footer className="text-gray-600 mt-12 fixed bottom-0 left-0 bg-white w-full">
      <div className="container mx-auto flex items-center flex-col sm:flex-row px-2 py-6">
        <a
          href="/"
          className="flex items-center justify-center md:justify-start text-gray-900"
        >
          <Image src="/logo.png" alt="logo" height={60} width={50} />
          <span className="ml-3 text-md">{"Coder's"} Blog App</span>
        </a>
        <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          © {currentYear} {"Coder's"} Blog App —
          <a
            href="https://suman-dev.in"
